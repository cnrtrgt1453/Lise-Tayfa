...
## Corpus Check
- 70 files · ~266,665 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 382 nodes · 661 edges · 40 communities (18 shown, 18 thin omitted)
...
1. `User` - 25 edges
2. `AuthRepository` - 25 edges
3. `CotxNavGraph()` - 21 edges
...
### Community 1 - "Direct Messaging & Chat Repository"
Cohesion: 0.08
...
Cohesion: 0.11
Nodes (26): UserSummary, CotxBottomBar(), CotxBottomTab, EXPLORE, HOME, MESSAGES, NOTIFICATIONS, PROFILE (+18 more)
...
### Community 4 - "Question & Solution Repository"
Cohesion: 0.15
Nodes (9): Question, Solution, Context, Result, Uri, QuestionRepository, QuestionDetailScreen(), SolutionItem() (+1 more)

### Community 5 - "Feed ViewModel & State"
Cohesion: 0.14
Nodes (13): Error, FeedTab, EXPLORE, FOLLOWING, FeedUiState, FeedViewModel, StateFlow, ViewModel (+5 more)

### Community 6 - "Auth Repository & User Model"
Cohesion: 0.18
...
### Community 9 - "Add Question Flow"
Cohesion: 0.16
Nodes (11): ExamSubjectHelper, AddQuestionUiState, AddQuestionViewModel, Error, Idle, Context, StateFlow, Uri (+3 more)
...
### Community 12 - "Google Sign-In Troubleshooting"
Cohesion: 0.22
...
- **Why does `User` connect `Auth Repository & User Model` to `Direct Messaging & Chat Repository`, `Core UI Screens & Navigation`, `Authentication Flow`, `Question & Solution Repository`, `Add Question Flow`, `Badge Helper & Edit Profile`?**
